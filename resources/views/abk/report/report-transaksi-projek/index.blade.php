...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">LAPORAN TRANSAKSI PROJEK</h1>
    </div>
        ...
        <div class="card-header py-3 d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <div class="form-group d-flex mb-0 align-items-center">
                    ...
                    <form action="{{ route('abk.export.transaksi.projek') }}" method="GET" class="d-flex align-items-center mr-3">
...
<script>
    $(document).ready(function () {
        $('#filterTanggal').on('change', function () {
            ...
            $.ajax({
                url: "{{ route('abk.filter.transaksi.projek') }}",
                type: "GET",
                data: { bulan: bulan },
