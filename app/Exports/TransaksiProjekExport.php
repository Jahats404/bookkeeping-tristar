...
class TransaksiProjekExport implements FromView, WithStyles, WithColumnFormatting, ShouldAutoSize
{
    protected $bulan;
    ...
    public function view():View
    {
        ...
        return view('abk.report.report-transaksi-projek.export-excel',compact('dt','bulan'));
    }
