...
class DetailTransaksiExport implements FromView, WithStyles, WithColumnFormatting, ShouldAutoSize
{
    protected $projek_id;
    protected $bulan;
    protected $namaProjek;
    
    public function __construct($projek_id,$bulan,$namaProjek)
    {
    ...
    {
        $dt = DetailTransaksi::where('projek_id', $this->projek_id)
        ...
        $namaProjek = $this->namaProjek;

        return view('abk.projek.export-excel', compact('dt','bulan','namaProjek'));
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle("D3:F$highestRow")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
    }
